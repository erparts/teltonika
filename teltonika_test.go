...
func TestJSONMarshal(t *testing.T) {
	buf, _ := hex.DecodeString("000000000000003608010000016B40D8EA30010000000000000000000000000000000105021503010101425E0F01F10000601A014E0000000000000000010000C7CF")
	reader := bytes.NewReader(buf)
	read, data, err := DecodeTCPFromReader(reader)
	if err != nil {
		t.Fatal(err)
	}
	if reader.Len() != 0 {
